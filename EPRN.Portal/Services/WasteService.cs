...
namespace EPRN.Portal.Services
{
    public class WasteService : IWasteService
    {
        ...
        public async Task<BaledWithWireViewModel> GetBaledWithWireModel(int journeyId, double? percentageDeduction)
        {
            ...
            if (vm.BaledWithWireDeductionPercentage == null || vm.BaledWithWireDeductionPercentage == 0)
                vm.BaledWithWireDeductionPercentage = percentageDeduction;
