...
public class QuarterMonthsServiceTests
{
    ...
    //{
    //    var result = QuarterlyDatesService.GetQuarterMonthsToDisplay(DateTime.Today, true);
    ...
    //{
    //    var result = QuarterlyDatesService.GetQuarterMonthsToDisplay(DateTime.Today.AddMonths(1), false);
    ...
    //{
    //    var result = QuarterlyDatesService.GetQuarterMonthsToDisplay(DateTime.Today.AddMonths(2), false);
