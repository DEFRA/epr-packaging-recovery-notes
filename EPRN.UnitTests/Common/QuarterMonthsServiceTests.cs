...
public class QuarterMonthsServiceTests
{
    ...
    {
        var result = QuarterMonthDisplay.GetQuarterMonthsToDisplay(DateTime.Today, false);
    ...
    {
        var result = QuarterMonthDisplay.GetQuarterMonthsToDisplay(DateTime.Today.AddMonths(1), false);
    ...
    {
        var result = QuarterMonthDisplay.GetQuarterMonthsToDisplay(DateTime.Today.AddMonths(2), false);
